                                        ...
                                        <table id="tech-companies-1" class="table  table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-priority="3">Code line</th>
                                            ...
                                            <tbody>
                                                @foreach ($datas as $data)
                                                    <tr>
                                                        <th>{{ $loop->index + 1 }}</th>
                                                        <td><img src="{{$data->image}}" style="width:50px" alt=""></td>
                                                        <td>{{$data->code_line}}</td>
                                                        <td>
                                                            <div class="d-flex justify-content-center ">
                                                                ...
                                                                {{-- <a id="delete-log" href="{{route('delete.banner',['id'=>$data->id])}}"
                            ...
                            <div class="modal-body">
                                <form action="{{route('add.banner')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Banner image</label><span class="text-danger"> *</span>
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Code line</label><span class="text-danger"> *</span>
                                        <input type="text" class="form-control" id="code-line" name="code_line"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{route('update.banner')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Banner image</label><span class="text-danger"> *</span>
                                        <input type="file" class="form-control" id="upd_img"
                                            aria-describedby="emailHelp" name="image" placeholder="Banner image">
                                    </div>
                                    @error('image')
                                        <div class="text-danger">{{ $message }}</div>
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Code line</label><span class="text-danger"> *</span>
                                        <input type="text" class="form-control" id="upd_code_line" name="code_line"
                                            placeholder="Code line">
                                    </div>
                                    @error('code_line')
                                        <div class="text-danger">{{ $message }}</div>
