                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group py-3">
                                ...
                                <input type="email" class="form-control" id="email" placeholder="Parents Name">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group py-3">
                                <label for="email">Guardian Name</label>
                                <input type="email" class="form-control" id="email" placeholder="Guardian Name">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group py-3">
                                <label for="email">Gender</label>
                                <input type="email" class="form-control" id="email" placeholder="Gender">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group py-3">
                                <label for="email">Date of birth</label>
                                <input type="email" class="form-control" id="email" placeholder="Date of birth">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group py-3">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group py-3">
                                ...
                                <input type="email" class="form-control" id="email" placeholder="Possible start date">
                            </div>
                        </div>
                        <div class="col-sm-12">
